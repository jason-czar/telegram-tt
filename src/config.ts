...
export const PRODUCTION_HOSTNAME = 'jason-czar.github.io/telegram-tt/';
export const PRODUCTION_URL = 'https://jason-czar.github.io/telegram-tt/';
export const WEB_VERSION_BASE = 'https://jason-czar.github.io/telegram-tt//'; // Used to redirect to other versions
